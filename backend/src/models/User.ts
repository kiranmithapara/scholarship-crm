...
User.init(
  {
    ...
    prepaidCost: { type: DataTypes.DECIMAL(10, 2), allowNull: true, defaultValue: 1500.00 },
    postpaidCost: { type: DataTypes.DECIMAL(10, 2), allowNull: true, defaultValue: 4500.00 },
